...
def setup_ui(main_window):
    ...
    main_window.init_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
    ...
    main_window.welcome_logo_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
    main_window.welcome_logo_label.setStyleSheet("margin: 10px;")
    ...
    main_window.logo_label.setStyleSheet("margin-left: 10px;")
